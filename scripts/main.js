...
class CitySelectionDetails extends CityCardDetails {
    ...
    getImageHTML() {
        return `<img src="images/city-icons/${this.cityName.toLowerCase()}.svg" alt="${this.cityName}">`;
    }
    ...
    getDateAndTimeHTML() {
        return `<b>${this.time} </b><img src="images/${this.meridiem.toLowerCase()}State.svg" alt='AM'><br><span>${super.getRequiredDateFormat()}</span>`;
    }
    ...
    setTimelineHTML(headTimeArray, headIconArray, headTempArray) {
        ...
        headIconArray.innerHTML = `<img id="image1" src="icons/${this.iconArray[0]}Icon.svg" alt="icon">`;
        ...
        for (let i = 1; i < 6; i++) {
            ...
            headIconArray.innerHTML += `<img id="image${i+1}" src="icons/${this.iconArray[i]}Icon.svg" alt="icon">`;
...
function updateContinentCards() {
    ...
    let contSort = (document.getElementsByClassName('up-down-icon')[0].children[0].src == "http://127.0.0.1:5500/images/arrowDown.svg");
    let tempSort = (document.getElementsByClassName('up-down-icon')[1].children[0].src == "http://127.0.0.1:5500/images/arrowDown.svg");
...
function scrollArrowsAppear() {
    ...
    cityCardContainer.innerHTML = `<div id="backarrow"><img src="/images/backwardArrow.svg" alt='backArrow'></div>` +
        cityCardContainer.innerHTML + `<div id="frontarrow"><img src="/images/forwardArrow.svg" alt='forwardArrow'></div>`;
...
continentSort.addEventListener('click', function(e) {
    if (this.children[0].children[0].src == "http://127.0.0.1:5500/images/arrowDown.svg") {
        this.children[0].children[0].src = "http://127.0.0.1:5500/images/arrowUp.svg";
    } else {
        this.children[0].children[0].src = "http://127.0.0.1:5500/images/arrowDown.svg"
    }
    updateContinentCards();
});
