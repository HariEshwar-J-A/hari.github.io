...
(async function() {
    ...
    async function cityDetailsChange(cityInput) {
        ...
        if (index > -1) {
            ...
            document.getElementsByClassName('city-img')[0].innerHTML = `<img src="images/city-icons/${selectedCity}.svg" alt="${cityInput}">`;
            ...
            city.populateTimeLine(nextFiveHrs, headTimeArray, headIconArray, headTempArray);
            return true;
        } else {
